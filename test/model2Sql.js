...
const model2Sql= require("../lib/model/model2Sql")
const dbTabla= require("../lib/dbTabla.js")
const connect = require("../lib/Connect")
const {MYSQL_DB,POSTGRESQL_DB,SQLITE_DB} = require("../lib/const")
describe("Test de la clase model2Sql",()=>
{
    ...
    it("metodo __cerateTable SQLITE_DB",()=>
    {
        //let sql=
        let table={
            tabla:'test1',
